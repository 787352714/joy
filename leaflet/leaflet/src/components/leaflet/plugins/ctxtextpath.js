...
(function()
{
  ...
  /* textPath function */
  CanvasRenderingContext2D.prototype.textPath = function (text, path, offset)
  {	// Helper to get a point on the path, starting at dl
    ...
    {	var letter = text[t];
      ...
      this.rotate(p[2]);
      if (this.lineWidth>0.1) this.strokeText(letter,offset[0],offset[1]);
      this.fillText(letter,offset[0],offset[1]);
      this.restore();
