...
(function () {
    ...
    class TextPolyLine extends L.Polyline {
        ...
        setText(text, options) {
            if (this._textNode && this._textNode.parentNode && svg) {
                svg.removeChild(this._textNode);
            }
            this._text = text;
    ...
    L.TextPolyline = TextPolyLine;
    L.textPolyLine = function(latlngs, options) {
        return new L.TextPolyline(latlngs, options);
    };
